...
\begin{figure}[htbp]
    \centering
    \subfloat[Smoothed reward over the training episodes]{\includegraphics[width=0.5\textwidth]{plots/episode_rewards_tdmpc.png}}
    \hspace{0.5cm} % Adds horizontal space between the two images
    \subfloat[Winrate vs BasicOpponent-weak across 250 matches]{\includegraphics[width=0.4\textwidth]{plots/winrate_tdmpc.png}}
